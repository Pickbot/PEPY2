...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Guilherme\n' // Nama kamu
            + 'ORG:Pepy;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5519999897566:+55 199989-7566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝙁 no chat por favor @${num.split('@')[0]} 😣✋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmão(ã). Você não está registrado como amigo de guilherme. Registre-se para fazer amizade com o bot Pepy por meio, \n\nCommand : ${prefix}registro nama|idade\nExemplo : ${prefix}daftar pepy|14\n\n──「 Pepy BOT 」──`,
			...
			const ownerNumber = ["5519999897566@s.whatsapp.net","+553493117667@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5519999897566@s.whatsapp.net","+553493117667@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5519999897566@s.whatsapp.net","+553493117667@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5519999897566@s.whatsapp.net","+553493117667@s.whatsapp.net"]//ubah nomor lo
			const premium = ["19999897566@s.whatsapp.net","+553493117667@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("bot")){
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/pepyjokes.js');
...
// recursos anime, random @pepy domina vida
          ...
          reply('Espere..')
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do GUI:*\n\n Tenho não kkkkk'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
