...
➛ *${prefix}bemvindo* 1 [recursso de boas vindas]
...
➛ *${prefix}figu*
➛ *${prefix}toimg*
➛ *${prefix}pepyjokes (memes aleatórios)*
➛ *${prefix}memeindo*
➛ *${prefix}tts*
➛ *${prefix}lolih [on]*
➛ *${prefix}nsfwloli [off]*
...
➛ *${prefix}modapk*
➛ *${prefix}indo10*
➛ *${prefix}comprarvip [para virar Premium]*
➛ *${prefix}qrcode*
➛ *${prefix}chentai*
➛ *${prefix}gcpf*
➛ *${prefix}gbin*
